...
import { Menu, LogOut, Edit, Trash2, PauseCircle, Save, PlayCircle, Building2 } from "lucide-react";
...
export default function AccountsPage({
  ...
  const handleDeleteConfirm = async () => {
    ...
    await supabase.from("org_accounts").delete().eq("id", deletingAccount.id);
          ...
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-6">
            ...
            >
              ...
              <div className="space-y-4">
                {getAccountsForOrg(selectedOrganization).length > 0 ? (
                  getAccountsForOrg(selectedOrganization).map(
                    (account, index) => (
                      <div
                        key={index}
